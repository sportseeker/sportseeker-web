...
-->
			...
			-->
			<div class="referrals2"><a href="<?php echo $this->static_settings['wp_elementor_link'];?>" target="_blank"><img src="<?php echo $this->helpers->baseURL;?>/assets/media/elementor.png"></a></div>
